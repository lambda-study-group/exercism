...
var _exercism$elm$Bob$notOnlyNumbers = function (text) {
	return A2(
...
var _exercism$elm$Bob$hey = function (msg) {
	return _exercism$elm$Bob$silent(msg) ? 'Fine. Be that way!' : ((_exercism$elm$Bob$shouting(msg) && _exercism$elm$Bob$notOnlyNumbers(msg)) ? 'Whoa, chill out!' : (_exercism$elm$Bob$question(msg) ? 'Sure.' : 'Whatever.'));
};
